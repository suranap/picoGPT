...
def main(prompt: str = "The brown fox jumps", n_tokens_to_generate: int = 40, model_size: str = "124M", models_dir: str = "models"):
    from utils import load_encoder_hparams_and_params, load_yelp_small
    ...
    data = load_yelp_small(encoder, hparams["n_ctx"])
    ...
    def objective(params, i) -> float:
        ...
        y[x[-1]] = 1.0  # one-hot target
        loss = cross_entropy_loss(y, y_pred)
        return loss

    objective_grad = grad(objective) 
    optimized_params = adam(objective_grad, params, step_size=0.001, num_iters=100)
